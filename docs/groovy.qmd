...
has a shortcut in Groovy - the "Elvis" opeartor:
...
Can you ammend this pipeline to create two channels that filter the reads to exclude any samples where the Q30 rate is less than 93.5%
